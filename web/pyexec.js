...
import "./lib/ace-builds/src-min-noconflict/ace.js";
import {
  createWindowModal,
  makeElement,
  findWidget,
...
ace.config.set(
  "basePath",
  new URL(
    "./lib/ace-builds/src-min-noconflict/",
    import.meta.url
  ).toString()
);
...
app.registerExtension({
  name: "Comfy.PyExec.Fork-ExperimentalNodesAlekPet",
  ...
  async beforeRegisterNodeDef(nodeType, nodeData, app) {
    ...
    if (nodeData.name === "PyExec" || nodeData.name === "PyExec_Output") {
      ...
      nodeType.prototype.onNodeCreated = async function () {
        ...
        // JS run
        api.addEventListener("pyexec_js_result", async ({ detail }) => {
          ...
          await new Promise((res) => {
            ...
            api
              .fetchApi("/pyexec/check_js_complete", {
                method: "POST",
                body: JSON.stringify({
